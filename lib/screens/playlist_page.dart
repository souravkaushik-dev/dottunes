...
class _PlaylistPageState extends State<PlaylistPage> {
  ...
  Widget _buildPlaylistImage() {
    return PlaylistCube(
      ...
      onClickOpen: false, isAlbum: null,
    );
  }
  ...
  Widget _buildSyncButton() {
    return IconButton(
      splashColor: Colors.transparent,
      highlightColor: Colors.transparent,
      icon: const Icon(HugeIcons.strokeRoundedClock03),
      iconSize: 26,
  ...
  Widget _buildEditButton() {
    return IconButton(
      splashColor: Colors.transparent,
      highlightColor: Colors.transparent,
      icon: const Icon(HugeIcons.strokeRoundedEditRoad),
      iconSize: 26,
  ...
  Widget _buildShuffleSongActionButton() {
    return IconButton(
      ...
      splashColor: Colors.transparent,
      highlightColor: Colors.transparent,
      icon: const Icon(HugeIcons.strokeRoundedShuffleSquare),
      iconSize: 25,
      onPressed: () {
  ...
  Widget _buildSortSongActionButton() {
    return DropdownButton<String>(
      ...
      elevation: 0,
      iconSize: 25,
      icon: const Icon(HugeIcons.strokeRoundedFilterVertical),
